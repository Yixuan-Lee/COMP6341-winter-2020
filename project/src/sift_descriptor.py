...
"""
the class is a template for creating a sift descriptor
this is used in image_descriptors.py
"""
class sift:
    ...
    def set_magnitude_and_theta(self):
        ...
        for i in range(16):
            for j in range(16):
                ...
                diff_x = self.window_18_18[w_18_18_i + 1, w_18_18_j] - \
                         self.window_18_18[w_18_18_i - 1, w_18_18_j]
                diff_y = self.window_18_18[w_18_18_i, w_18_18_j + 1] - \
                         self.window_18_18[w_18_18_i, w_18_18_j - 1]
